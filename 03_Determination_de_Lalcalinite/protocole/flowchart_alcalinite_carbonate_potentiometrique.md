# Organigramme de la Détermination de l'Alcalinité Carbonate Potentiométrique (ISO 9963-2)
...
graph TD
    %% Début de l'analyse
    Start(["Début de l'analyse"]) --> Prep["Préparer & Calibrer le pH-mètre<br>(tampons pH 4, 7 et 9)<br>Mettre en place le barbotage de gaz sans CO2"]
    Prep --> Dispatch{"Action à réaliser ?"}

    %% --- ETAPE 1 : ETALONNAGE ACIDE (AVANT UTILISATION) ---
    Dispatch -->|"Étalonnage HCl ~0,020 mol/L"| E1["Pipeter 2,00 mL de Na2CO3 ~0,025 mol/L (3)<br>+ 40 mL d'eau purifiée (1)<br>Déclencher le barbotage de gaz sans CO2 (2)"]
    E1 --> E2["Titrer avec HCl ~0,020 mol/L (4)<br>jusqu'à pH 5,4 ± 0,05 (stable 30 s)<br>Enregistrer le volume V2"]
    E2 --> E2_Check{"3 répétitions faites ?<br>(différence max-min < 0,05 mL)"}
    E2_Check -->|Non| E1
    E2_Check -->|Oui| E3["Titrer le blanc (50 mL d'eau purifiée (1))<br>dans les mêmes conditions<br>Enregistrer le volume V3"]
    E3 --> E4["Calculer concentration réelle c(HCl)<br>c(HCl) = 2 * m * V1 / (53,00 * (V2 - V3))"]
    E4 --> E_End["Acide chlorhydrique ~0,020 mol/L étalonné"]

    %% --- ETAPE 2 : DOSAGE DE L'ÉCHANTILLON ---
    Dispatch -->|"Dosage de l'Échantillon"| S1["Pipeter 50,0 mL d'échantillon d'eau (V4)<br>Déclencher le barbotage de gaz sans CO2 (2)"]
    S1 --> S2["Titrer avec HCl ~0,020 mol/L (4)<br>sous barbotage constant jusqu'à pH 5,4<br>(vérifier la stabilité pendant 30 s)"]
    ...
    Dispatch -->|"Essai à Blanc"| B1["Introduire 50 mL d'eau purifiée (1)<br>Déclencher le barbotage de gaz sans CO2 (2)"]
    B1 --> B2["Titrer sous barbotage avec HCl (4)<br>jusqu'à pH 5,4"]
