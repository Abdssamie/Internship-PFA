...
graph LR
    ...
    E1 --> E2["Ajouter 75 mL d'eau de qualité 2"]
    E2 --> E3["Titrer avec HCl ~0,1 mol/L sous agitation<br>jusqu'à pH 4,5 ± 0,05"]
    ...
    Dispatch -->|"Dosage de l'Échantillon"| S1["Pipeter 100,0 mL d'échantillon d'eau (V4)"]
    S1 --> S2["Mesurer le pH initial (pHi) sous agitation lente"]
    S2 --> S3{"pHi >= 8,3 ?"}

    %% Branche pHi < 8,3 (Pas d'alcalinité composite)
    S3 -->|Non| S_Ap_Zero["Alcalinité composite Ap = 0 mmol/L"]
    S_Ap_Zero --> S_Tit_AT["Continuer le titrage sous agitation lente<br>jusqu'à pH 4,5 ± 0,05"]
    ...
    S_Acid_Fort & S_Acid_Faible --> S_Tit_Ap["Titrer sous agitation lente jusqu'à pH 8,3"]
